...
import DailyCache from '../model/mys/DailyCache.js'
import common from '../../../lib/common/common.js'
export default class MysInfo {
  static tips = '请先发送【#ck帮助】绑定ck和sk'
  ...
  static async getUid(e, matchMsgUid = true) {
    ...
    if (at) {
      ...
      if (e.noTips !== true) e.reply('尚未绑定uid\n请发送【#绑定xxxxxxxxx】', false, { at })
      return false
    }
  ...
  static async getSelfUid(e) {
    ...
    if (!selfUser.hasCk) {
      if (e.noTips !== true) e.reply('尚未绑定cookie\n请发送【#ck帮助】', false, { at: selfUser.qq })
      return false
    }
